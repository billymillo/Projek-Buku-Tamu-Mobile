...
class _ParentFormPageState extends State<ParentFormPage> {
  ...
  final ParentController parentC = Get.put(ParentController());
                ...
                Expanded(
                  child: RefreshIndicator(
                    onRefresh: () async {
                      ...
                      selectedPurpose = null;
                      parentC.savedSignatureFile.value = null;
                      parentC.signatureController.clear();
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              inputField(
                                  'Orang Tua Dari', " *", studentController),
                              Padding(
                                padding: const EdgeInsets.only(bottom: 16),
                                child: DropdownButtonFormField<String>(
                                  value: selectedRayon,
                                  hint: const Text('Masukkan Nama Rayon',
                                      style: TextStyle(
                                          fontSize: 12,
                                          fontFamily: 'roboto',
                              ...
                              GestureDetector(
                                ...
                                child: Obx(() {
                                  return Container(
                                    ...
                                    child: Center(
                                      child: parentC.savedSignatureFile.value !=
                                              null
                                          ? Image.file(
                                              parentC.savedSignatureFile.value!,
                                                    ...
                                                    Column(
                                                      children: [
                                                        ...
                                                        const SizedBox(
                                                            height: 10),
                                                        const Text(
                                                          "Apakah data Kunjungan Orang Tua sudah sesuai yang diinginkan?",
                                                          style: TextStyle(
                                                            color:
                                                                Color.fromARGB(
                                                                    133,
